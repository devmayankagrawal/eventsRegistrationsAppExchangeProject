...
import publicStatusUpdateMethod from '@salesforce/apex/EventRegistrationClass.publicStatusUpdateMethod';
...
export default class PublicEventsComponent extends LightningElement {
	...
	/*handleContinue06() {
		...
		if (!this.hasPreviousCgContacts && (!this.contactObject.LastName || !this.contactObject.MobilePhone || !this.contactObject.Birthdate || !this.contactObject.OrgEventManager__Education_Level__c || !this.contactObject.OrgEventManager__Gender__c || !this.contactObject.OrgEventManager__Religion__c || !this.contactObject.OrgEventManager__Race__c || !this.contactObject.Email || !this.contactObject.OrgEventManager__Marital_Status__c || !this.contactObject.OrgEventManager__Citizenship__c || !this.contactObject.OrgEventManager__Housing_Type__c || !this.contactObject.OrgEventManager__Employment_Status__c || !this.contactObject.OrgEventManager__Block_House_Number__c || !this.contactObject.OrgEventManager__Street_Name__c || !this.contactObject.OrgEventManager__Floor__c || !this.contactObject.OrgEventManager__Unit_No__c || !this.contactObject.OrgEventManager__Country__c || !this.contactObject.OrgEventManager__Postal_Code__c || !this.contactObject.OrgEventManager__Relationship_to_registrant__c || !this.contactObject.OrgEventManager__Are_you_living_with_registrant__c || !this.contactObject.OrgEventManager__Is_this_your_first_time_attending_event__c)) {
			this.handleAlertClick('Please fill the required fields in the form');
			
		} else if (!isAnyCheckboxChecked && (!this.contactObject.LastName || !this.contactObject.MobilePhone || !this.contactObject.Birthdate || !this.contactObject.OrgEventManager__Education_Level__c || !this.contactObject.OrgEventManager__Gender__c || !this.contactObject.OrgEventManager__Religion__c || !this.contactObject.OrgEventManager__Race__c || !this.contactObject.Email || !this.contactObject.OrgEventManager__Marital_Status__c || !this.contactObject.OrgEventManager__Citizenship__c || !this.contactObject.OrgEventManager__Housing_Type__c || !this.contactObject.OrgEventManager__Employment_Status__c || !this.contactObject.OrgEventManager__Block_House_Number__c || !this.contactObject.OrgEventManager__Street_Name__c || !this.contactObject.OrgEventManager__Floor__c || !this.contactObject.OrgEventManager__Unit_No__c || !this.contactObject.OrgEventManager__Country__c || !this.contactObject.OrgEventManager__Postal_Code__c || !this.contactObject.OrgEventManager__Relationship_to_registrant__c || !this.contactObject.OrgEventManager__Are_you_living_with_registrant__c || !this.contactObject.OrgEventManager__Is_this_your_first_time_attending_event__c)) {
		...
		} else if(isAnyCheckboxChecked && this.caregiverFormFlag==true && (!this.contactObject.LastName || !this.contactObject.MobilePhone || !this.contactObject.Birthdate || !this.contactObject.OrgEventManager__Education_Level__c || !this.contactObject.OrgEventManager__Gender__c || !this.contactObject.OrgEventManager__Religion__c || !this.contactObject.OrgEventManager__Race__c || !this.contactObject.Email || !this.contactObject.OrgEventManager__Marital_Status__c || !this.contactObject.OrgEventManager__Citizenship__c || !this.contactObject.OrgEventManager__Housing_Type__c || !this.contactObject.OrgEventManager__Employment_Status__c || !this.contactObject.OrgEventManager__Block_House_Number__c || !this.contactObject.OrgEventManager__Street_Name__c || !this.contactObject.OrgEventManager__Floor__c || !this.contactObject.OrgEventManager__Unit_No__c || !this.contactObject.OrgEventManager__Country__c || !this.contactObject.OrgEventManager__Postal_Code__c || !this.contactObject.OrgEventManager__Relationship_to_registrant__c || !this.contactObject.OrgEventManager__Are_you_living_with_registrant__c || !this.contactObject.OrgEventManager__Is_this_your_first_time_attending_event__c)){
			this.handleAlertClick('Please fill the required fields in the form.');
		}
		else{
    ...
    handleSubmit() {
        ...
        if (this.caregiverFormFlag==true && this.contactForms.length === 0) {
			this.handleAlertClick('Please add at least one person.');
			return; // Stop execution
		}
		console.log('Final contactForms:', JSON.stringify(this.contactForms));
	...
	async handleDashboardSessions() {
		const selectedeventt = this.selectedIDS.join(',');
		console.log("Selected EventIds=======", selectedeventt);
        console.log("I am from publicStatusUpdateMethod");
		publicStatusUpdateMethod({
				selectedEventIds: selectedeventt,
				cgContactIds: this.cgContactIds
			})
			.then((result) => {
